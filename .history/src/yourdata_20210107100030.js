...
export default {
  ...
  sponsors: [
    { id: 1, col: 1, row: 1, img: xboxIcon },
    { id: 2, col: 2, row: 2, img: blueIcon },
    { id: 3, col: 3, row: 1, img: dotsIcon },
    { id: 4, col: 4, row: 2, img: wolframIcon },
    { id: 5, col: 5, row: 1, img: stairsIcon },
  ],
