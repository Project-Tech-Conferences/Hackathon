...
export default {
  ...
  sponsors: [
    { icon: "balsamiq", id: 1, img: balsamiqIcon },
    { icon: "password", id: 2, img: passIcon },
    { icon: "balsamiq", id: 3, img: dotsIcon },
    { icon: "balsamiq", id: 4, img: wolframIcon },
    { icon: "balsamiq", id: 5, img: stairsIcon },
  ],
