...
export default {
  ...
  sponsors: [
    {id: 1, icon: "balsamiq",  img: balsamiqIcon },
    { id: 2,icon: "password",  img: passIcon },
    { id: 3,icon: "dots",  img: dotsIcon },
    {id: 4, icon: "wolfram",  img: wolframIcon },
    { icon: "stairs", id: 5, img: stairsIcon },
  ],
