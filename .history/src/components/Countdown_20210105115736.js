...
const calculateTimeLeft = () => {
  ...
  if (difference > 0) {
    timeLeft = {
      months: addZero(Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4)))
        ? `0${Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4))}`
        : Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4)),

      weeks: addZero(Math.floor(difference / (1000 * 7 * 60 * 60 * 24)))
        ? `0${Math.floor(difference / (1000 * 7 * 60 * 60 * 24))}`
        : Math.floor(difference / (1000 * 7 * 60 * 60 * 24)),

      days: addZero(Math.floor(difference / (1000 * 60 * 60 * 24)))
        ? `0${Math.floor(difference / (1000 * 60 * 60 * 24))}`
        : Math.floor(difference / (1000 * 60 * 60 * 24)),

      hours: addZero(Math.floor(difference / (1000 * 60 * 24)) % 24)
        ? `0${Math.floor((difference / (1000 * 60 * 24)) % 24)}`
        : Math.floor((difference / (1000 * 60 * 24)) % 24),
      minutes:       hours: addZero(Math.floor(difference / (1000 * 60 * 24)) % 24)
      ? `0${Math.floor((difference / (1000 * 60 * 24)) % 24)}`
      : Math.floor((difference / (1000 * 60 * 24)) % 24),
