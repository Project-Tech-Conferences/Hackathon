...
const calculateTimeLeft = () => {
  ...
  let difference = startDateTime - endDateTime
            ...
            <div className="countdown">
              {timerComponents.length ? (
                ...
                <div className="countdownFinished">
                  <span className="timer-done"style={{ color: "style={{ color: "rgb(124, 114, 232)" }}" }}>PTC</span>
                  <span className="timer-done">Hacks</span>
                  <span className="timer-done">has</span>
                  <span
