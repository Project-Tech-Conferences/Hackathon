...
const calculateTimeLeft = () => {
  ...
  let hackDate = +new Date(`02/03/${year}`)
  ...
  if (difference > 0) {
    timeLeft = {
      months: Math.floor((difference / (1000 * 7 * 60 * 60 * 24 * 4)) % 4),
            ...
            <div className="countdown">
              ...
              {timerComponents.length ? (
                <>
                  ...
                  <h2 className="weeks">
                    {timeLeft.weeks} <div className="time-left">months</div>
                  </h2>
                  <h2 className="days">
                    {timeLeft.days} <div className="time-left">months</div>
                  </h2>
                  <h2 className="hours">
                    {timeLeft.hours} <div className="time-left">months</div>{" "}
                  </h2>
                  <h2 className="minutes">
                    {timeLeft.minutes} <div className="time-left">months</div>{" "}
                  </h2>
                  <h2 className="seconds">
                    {timeLeft.seconds} <div className="time-left">months</div>{" "}
                  </h2>
                </>
              ) : (
