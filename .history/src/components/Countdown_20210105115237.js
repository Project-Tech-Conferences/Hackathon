...
const calculateTimeLeft = () => {
  ...
  let timeLeft = {}
  console.log(1 < Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4)) < 10)
  ...
  if (difference > 0) {
    timeLeft = {
      ...
      weeks: 
      addZero(Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4)))
        ? `0${Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4))}`
        : Math.floor(difference / (1000 * 7 * 60 * 60 * 24 * 4))Math.floor(difference / (1000 * 7 * 60 * 60 * 24)),Math.floor(difference / (1000 * 7 * 60 * 60 * 24))
